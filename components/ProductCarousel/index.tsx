              ...
              <div className="w-full sm:w-1/2 p-4 sm:p-6 md:p-8 flex flex-col align-center justify-content-center items-center">
                <div className="space-y-3 text-left">
                  ...
                  <Link href={`/product/${product._id}`} passHref>
                    <button className="mt-12 sm:mt-4 bg-transparent text-gray-800 hover:text-gray-900 px-4 sm:px-6 py-2 rounded-3xl hover:bg-gray-800 transition-colors text-sm sm:text-base border-2 border-gray-800 bodrer-solid group">
